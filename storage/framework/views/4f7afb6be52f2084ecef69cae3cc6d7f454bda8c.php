		...
		<div class="row">
			<div class="col">
				...
				<div class="product_grid">
					...
					<!-- выводим 8 самых новых продуктов -->
					<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="product">
						...
						<div class="product_extra product_new"><a href="<?php echo e(Route('categories')); ?>">New</a></div>
						<div class="product_content">
							<div class="product_title"><a href="product.html"><?php echo e($value->title); ?></a></div>
							<div class="product_price">$<?php echo e($value->price); ?></div>
						</div>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\Larawel-create-shop\shop\resources\views/index/index.blade.php ENDPATH**/ ?>