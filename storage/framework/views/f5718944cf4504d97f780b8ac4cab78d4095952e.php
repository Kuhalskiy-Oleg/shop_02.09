...
<?php $__env->startSection('title','Sign in - forgot'); ?>
...
<div class="container boot">
	<div class="row main-form">
		...
		<form  method="post" action="<?php echo e(Route('auth.forgot_process')); ?>">

			<!-- для работы csrf в теге head должен быть прописан мета тег с csrf токеном -->
			<!-- CSRF-атаки — это атаки на стороне клиента, которые могут использоваться для перенаправления пользователей на вредоносный веб-сайт, кражи конфиденциальной информации или выполнения других действий в рамках сеанса пользователя. -->
			<!-- "собака"ccsrf - для обработки тех форм которые запускаются на нашем сайте  -->
			<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
			...
			<div class="password" style="display: block;width: 100%;">
				<a href="<?php echo e(Route('auth.login')); ?>" style="color: white;font-size: 15px;text-decoration: underline;">Вернутся обратно</a>
			</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\Larawel-create-shop\shop\resources\views/auth/forgot.blade.php ENDPATH**/ ?>