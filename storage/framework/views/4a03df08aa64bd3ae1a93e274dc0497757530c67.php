						...
						<div class="home_content">
							<div class="breadcrumbs">
								<ul>
									...
									<li><a href="<?php echo e(Route('cart.view')); ?>">Shopping Cart</a></li>
									<li>Checkout</li>
								</ul>
							</div>
						</div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\Larawel-create-shop\shop\resources\views/pages/checkout.blade.php ENDPATH**/ ?>