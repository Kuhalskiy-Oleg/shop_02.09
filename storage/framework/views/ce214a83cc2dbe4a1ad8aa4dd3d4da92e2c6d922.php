	...
	<div class="container">
		...
		<div class="row cart_items_row">
			<div class="col">
				...
				<?php 
					//смотрим на id пользователя
					// echo 'id user = '.@auth()->user()->id;
					// echo "<br>";
					// //cмотрим на корзину с товарами
					// $a = \Cart::session(@auth()->user()->id)->getContent();
					// var_dump($a);
					// print_r($a[2]['attributes']['img']);

					// echo "<br><br>".'count = '.$a->count()."<br><br>";

					// foreach ($a as $value) {
					// 	echo 'id product = '.$value->id."<br>";
					// 	echo 'slug product = '.$value->attributes->slug."<br>";
					// }
		...
		$('.cart_item_edit[data-edit]').click(function(e){
			...
			$.ajax({
				...
				success:(data) => {
					...
					//console.log("<?php $__errorArgs = ['count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> $message <?php unset($message);
		...
		$('.cart_item_edit[data-delete]').click(function(e){
			...
			$.ajax({
				...
				success:(data) => {
					...
					// let id = data['id'];
					// console.log(id)
					// console.log($(`div[data-idproduct=${id}]`))
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\Larawel-create-shop\shop\resources\views/cart/cart.blade.php ENDPATH**/ ?>