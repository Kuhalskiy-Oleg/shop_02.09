...
unset($__errorArgs, $__bag); ?>">
							<!-- aria-hidden означает что элемент показывать необязательно. -->
				...
				<div class="form-group">
					...
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
							<!-- password_confirmation - сравниваемый пароль всегда должен быть прописан так -->
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\Larawel-create-shop\shop\resources\views/auth/registration.blade.php ENDPATH**/ ?>